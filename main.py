        ...
        for d1 in range(multi_sampling):
            for d2 in range(multi_sampling):
                ...
                im[i, ~ok, 0] += (
                    ...
                    atmos_illum * atmos_colour[0]) / multi_sampling**2
                im[i, ~ok, 1] += (
                    im_rgbref_base[i, ~ok, d1, d2, 1] +
                    atmos_illum * atmos_colour[1]) / multi_sampling**2
                im[i, ~ok, 2] += (
                    im_rgbref_base[i, ~ok, d1, d2, 2] +
                    atmos_illum * atmos_colour[2]) / multi_sampling**2
