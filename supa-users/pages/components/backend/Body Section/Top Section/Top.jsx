...
//import video1 from '../../../../assets/video1.mp4'; // update directory later /#/ Generate this from user view (i.e. what would be seen if user was in Unity) later
      ...
      <div className='cardSection flex'>
        <div className='rightCard flex'>
          ...
          <div className='videoDiv'>
            <ReactPlayer url='https://www.youtube.com/watch?v=1Z_hcPVXiA8' />
